...
from rlcard.games.bluffgame import Dealer
from rlcard.games.bluffgame import Player
from rlcard.games.bluffgame import Judger
from rlcard.games.bluffgame import Round
...
class BluffGame(Game):
    ...
    def is_over(self):
        ...
        if self.round_counter >= 2:  # modified
            return True
        return False
    ...
    def step_back(self):
        ...
        if len(self.history) > 0:
            self.round, r_raised, self.game_pointer, self.round_counter, d_deck, self.players, ps_hand = self.history.pop()
