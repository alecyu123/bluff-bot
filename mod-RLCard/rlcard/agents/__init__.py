...
if 'torch' in installed_packages:
    ...
    from rlcard.agents.modified_dqn_agent import VAEDQNAgent as VAEDQNAgent
...
from rlcard.agents.human_agents.bluffgame_human_agent import HumanAgent as BluffgameHumanAgent
...
from rlcard.agents.aggressive_agent import AggressiveAgent
